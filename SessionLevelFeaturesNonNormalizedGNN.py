...
def train_gnn_model(X, y, test_size=0.2, epochs=200, lr=0.001, batch_size=16):
    ...
    train_loader = DataLoader(
        ...
        batch_size=batch_size, shuffle=True, generator=torch_generator, worker_init_fn=None
    )
...
model, train_acc, label_encoder = train_gnn_model(X_train, y_train, epochs=200, test_size=0.2)
